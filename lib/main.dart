...
class RandomWordsState extends State<RandomWords> {
  ...
  final _saved = new Set<WordPair>();//存储用户喜欢（收藏）的单词对,Set比List更合适，
  // 因为Set中不允许重复的值
  final _biggerFont = const TextStyle(fontSize: 18.0);//变量来增大字体大小
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold (
      appBar: new AppBar(
        ...
        //AppBar添加一个列表图标,而其它一些属性，如action，需要一组widgets(children），
        // 用方括号[]表示
        actions:<Widget> [
